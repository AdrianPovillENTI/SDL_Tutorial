...
typedef struct SDL_MouseWheelEvent
{
    ...
    SDL_MouseWheelDirection targetPos; /**< Set to one of the SDL_MOUSEWHEEL_* defines. When FLIPPED the values in X and Y will be opposite. Multiply by -1 to change them back */
